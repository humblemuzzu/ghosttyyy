...
export const PROVIDERS = ["anthropic", "copilot", "gemini", "antigravity", "codex", "kiro", "grok", "zai"] as const;
...
export const PROVIDER_METADATA: Record<ProviderName, ProviderMetadata> = {
	...
	grok: {
		displayName: "Grok",
		// pi models.json uses provider id "xai" for grok-*; z.ai used to claim
		// "xai" and stole detection while disabled, which blanked the whole bar.
		detection: { providerTokens: ["grok", "xai"], modelTokens: ["grok"] },
	},
	zai: {
		displayName: "z.ai",
