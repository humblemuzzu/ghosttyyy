...
export const PROVIDERS = ["anthropic", "copilot", "gemini", "antigravity", "codex", "kiro", "zai", "crof", "kimi"] as const;
...
export const PROVIDER_METADATA: Record<ProviderName, ProviderMetadata> = {
	...
	crof: {
		displayName: "CrofAI",
		detection: { providerTokens: ["crof"], modelTokens: [] },
	},
	kimi: {
		displayName: "Kimi For Coding",
		detection: { providerTokens: ["kimi", "kimi-coding"], modelTokens: ["kimi", "k2p6"] },
	},
};
