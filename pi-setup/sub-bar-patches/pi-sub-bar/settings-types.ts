...
export interface KimiProviderSettings extends BaseProviderSettings {
	windows: {
		showWeek: boolean;
		show5h: boolean;
	};
...
export interface CrofProviderSettings extends BaseProviderSettings {
	windows: {
		showDay: boolean;
		showCredits: boolean;
	};
